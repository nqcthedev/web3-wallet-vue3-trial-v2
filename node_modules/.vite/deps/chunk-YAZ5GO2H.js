...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (OptionsController.state.features?.reownAuthentication || OptionsController.state.remoteFeatures?.reownAuthentication) {
      const { ReownAuthentication } = await import("./features-2CAATPQE.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-3XIYSPD6.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-4ACSORAE.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-ON3MW6KX.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-IH23KNEF.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-SJIDGUVZ.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-6AL5VBWN.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-QIFCPBLN.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-VD6DEIP7.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-CMYYHS5E.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-BTTC52QO.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-G7DTBMAD.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-4EAU36MJ.js"),
      import("./w3m-modal-ZQCW7BOF.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-YAZ5GO2H.js.map
