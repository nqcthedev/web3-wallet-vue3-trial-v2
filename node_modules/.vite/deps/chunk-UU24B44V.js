...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-64TZACHC.js");
  const signature_ = (() => {
...
function wrap2(value) {
  ...
  return concat(signature, suffix, suffixLength, magicBytes2);
}
...
//# sourceMappingURL=chunk-UU24B44V.js.map
