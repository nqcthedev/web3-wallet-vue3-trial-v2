    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./dist-D3YF7EOI.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./connectors_false-H4S45Y6R.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { GeminiWalletProvider } = await (() => {
          try {
            return import("./connectors_false-NCWGSE3Q.js");
          } catch {
      ...
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await (() => {
            try {
              return import("./connectors_false-O5F6MZS6.js");
            } catch {
        ...
        try {
          if (!accounts?.length && !isReconnecting) {
            const { RpcSchema } = await (() => {
              try {
                return import("./connectors_false-AMVTEWBN.js");
              } catch {
            ...
            const { z } = await (() => {
              try {
                return import("./connectors_false-YOF7VL3V.js");
              } catch {
      ...
      if (!provider_) {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./dist-3RA3KY22.js");
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("./connectors_false-AL6IKZCA.js");
          } catch {
...
//# sourceMappingURL=exports-WCNF7WCA.js.map
